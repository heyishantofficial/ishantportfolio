...
import { 
  Sliders, Image, Lock, Sun, Moon, Volume2, VolumeX, ShieldCheck, Check, Sparkles, Monitor, Key, Upload
} from "lucide-react";
            ...
            <div className="space-y-5 max-w-lg">
              <div>
                <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 tracking-tight mb-1 flex items-center gap-2">
                  ...
                  <span>Password & Lock Screen Security</span>
                </h2>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Manage your workstation login password for unlocking the desktop and system tools.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-white/60 dark:bg-white/10 border border-white/60 dark:border-white/10 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-800 dark:text-slate-100">System Password Protection</div>
                      <div className="text-[11px] text-slate-500 dark:text-slate-400">Status: <span className="font-semibold text-emerald-600 dark:text-emerald-400">Active</span></div>
                    </div>
                  </div>
